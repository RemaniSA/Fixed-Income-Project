...
# -----------------
# 2. build future schedule from today to maturity
# ------------------
...
# ------------
# 3. build cash flows for best and worst case scenarios
# ---------------
...
# -------------
# 5. plot coupon comparison (side-by-side bars)
# -------------------
