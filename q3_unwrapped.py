...
# load MarketData file and put helpers to work
...
# ----------------------------
# 2. build bootstrapped curves using different interpolators
# ----------------------------
...
# ----------------------------
# 5. loop through curves and plot
# ----------------------------
...
for name, curve in curves.items():
    ...
    # reduce xticks so they can be read
    tick_count = 5
...
# ----------------------------
# 6. compare the smoothness of fwd curves
# ----------------------------
